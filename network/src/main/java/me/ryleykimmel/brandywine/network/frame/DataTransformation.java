...
public enum DataTransformation {
  ...
  /**
   * The simplest of the three, the negate transformation simply inverts the sign bit of the value (i.e. a positive value becomes negative, and a negative value becomes positive).
   * This transformation is only used on byte values.
   */
  NEGATE
