...
public final class Session {
     ...
     */
    public Session(SocketChannel channel, FrameMetadataSet frameMetadataSet, MessageReceivedListener messageReceivedListener) {
     ...
     * Closes this Session.
     * <p>
     * This method is not intended to provide additional functionality or be overridden.
     * If you wish to perform other events on channel close see {@link Session#onClose(ChannelFutureListener)}.
     * </p>
     */
    public void close() {
        if (closed) {
