...
public final class AddPlayerDescriptorEncoder
    implements PlayerDescriptorEncoder<AddPlayerDescriptor> {

  @Override
  public void encode(AddPlayerDescriptor descriptor, PlayerUpdateMessage message,
