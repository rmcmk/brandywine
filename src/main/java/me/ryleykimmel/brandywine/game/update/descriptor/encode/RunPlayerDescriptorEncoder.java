...
public final class RunPlayerDescriptorEncoder implements PlayerDescriptorEncoder<RunPlayerDescriptor> {

	@Override
	public void encode(RunPlayerDescriptor descriptor, PlayerUpdateMessage message, FrameBuilder builder, FrameBuilder blockBuilder) {
		builder.putBits(1, 1);
		builder.putBits(2, 2);
