...
public final class UpdateBlockEncoderSet {
	...
	private final Map<Class<? extends UpdateBlock>, UpdateBlockEncoder<? extends Message, ? extends UpdateBlock>> blocks = new HashMap<>();
	...
	public <M extends Message, B extends UpdateBlock> void encode(B block, M message, FrameBuilder builder) {
