...
public final class AppearancePlayerBlockEncoder implements PlayerUpdateBlockEncoder<AppearancePlayerBlock> {

	@Override
	public void encode(AppearancePlayerBlock block, PlayerUpdateMessage message, FrameBuilder builder) {
