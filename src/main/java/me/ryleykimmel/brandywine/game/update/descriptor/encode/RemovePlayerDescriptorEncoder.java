...
public final class RemovePlayerDescriptorEncoder implements PlayerDescriptorEncoder<RemovePlayerDescriptor> {

	@Override
	public void encode(RemovePlayerDescriptor descriptor, PlayerUpdateMessage message, FrameBuilder builder, FrameBuilder blockBuilder) {
		builder.putBits(1, 1);
		builder.putBits(2, 3);
	}
