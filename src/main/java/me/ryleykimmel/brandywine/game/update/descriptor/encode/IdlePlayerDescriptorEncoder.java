...
public final class IdlePlayerDescriptorEncoder implements PlayerDescriptorEncoder<IdlePlayerDescriptor> {

	@Override
	public void encode(IdlePlayerDescriptor descriptor, PlayerUpdateMessage message, FrameBuilder builder, FrameBuilder blockBuilder) {
