...
public final class EventListenerChainSet {
   ...
   */
  private final Map<Class<? extends Event>, EventListenerChain<? extends Event>> chains =
      new HashMap<>();
   ...
   *
   * @param clazz The {@link Class} to associate the EventListenerChain with. @param listener The
   * EventListenerChain.
   */
  public <E extends Event> void putListener(Class<E> clazz, EventListener<E> listener) {
    @SuppressWarnings("unchecked")
    EventListenerChain<E> chain =
        (EventListenerChain<E>) chains.computeIfAbsent(clazz, EventListenerChain::new);
