...
public final class PlayerCredentials {
	...
	/**
	 * Constructs a new {@link PlayerCredentials} with the specified user id, username, password and session keys.
	 * 
	...
	public String toString() {
		return MoreObjects.toStringHelper(this).add("userId", userId).add("username", username).add("password", password).add("encodedUsername", encodedUsername)
