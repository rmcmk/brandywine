...
public final class CommandArguments {
   ...
   */
  public boolean remaining(int amount) {
    return remaining() >= amount;
  }

  /**
   * Tests whether or not there is exactly {@code amount} remaining arguments.
   * 
   * @param amount The amount of arguments.
   * @return {@code true} iff there is exactly {@code amount} arguments, otherwise {@code false}.
   */
  public boolean remainingExact(int amount) {
    return remaining() == amount;
  }
