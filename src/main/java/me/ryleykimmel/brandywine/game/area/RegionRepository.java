...
public final class RegionRepository {
   ...
   * @throws UnsupportedOperationException If the coordinates of the provided Region are already
   * mapped (and hence the existing Region would be replaced), and removal of regions is not
   * permitted.
   */
