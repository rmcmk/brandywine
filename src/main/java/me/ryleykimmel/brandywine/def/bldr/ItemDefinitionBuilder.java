...
public final class ItemDefinitionBuilder extends DefinitionBuilder<ItemDefinition> {
	...
	public ItemDefinition build() {
		return new ItemDefinition(description, groundMenuActions, groundScales, id, inventoryMenuActions, members, name, noteInfoId, noteTemplateId, stackable, team, value);
	}
