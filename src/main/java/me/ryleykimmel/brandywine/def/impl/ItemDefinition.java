package me.ryleykimmel.brandywine.def.impl;

import java.util.List;

import com.google.common.base.MoreObjects;

import me.ryleykimmel.brandywine.def.Definition;
...
public final class ItemDefinition extends Definition {
	 ...
	 */
	public ItemDefinition(String description, List<String> groundMenuActions, List<Integer> groundScales, int id, List<String> inventoryMenuActions, boolean members, String name,
			int noteInfoId, int noteTemplateId, boolean stackable, int team, int value) {
		super(id);
	...
	public String toString() {
		return MoreObjects.toStringHelper(this).add("id", id).add("description", description).add("groundMenuActions", groundMenuActions).add("groundScales", groundScales)
				.add("inventoryMenuActions", inventoryMenuActions).add("members", members).add("name", name).add("noteInfoId", noteInfoId).add("noteTemplateId", noteTemplateId)
