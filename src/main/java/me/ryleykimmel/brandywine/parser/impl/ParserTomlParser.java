...
public final class ParserTomlParser extends TomlParser {
	 ...
	 * @throws IllegalAccessException If the Parsers constructor object is enforcing Java language access control and the underlying constructor is inaccessible.
	...
	private Parser<?, ?> find(Class<Parser<?, ?>> clazz, String path) throws InstantiationException, IllegalAccessException, InvocationTargetException, NoSuchMethodException {
		...
		throw new NoSuchMethodException(
				"Unable to find suitable constructor, only " + className + "(String), " + className + "(ServerContext) or " + className + "(String, ServerContext) are permitted.");
	}
