...
public final class ByteBufUtil {
   ...
   *
   * @param buffer The ByteBuf to write the String to. @param string The String to write.
   */
   ...
   *
   * @param buffer The ByteBuf to read from. @return The null-terminated String.
   */
   ...
   *
   * @param buffer The ByteBuf to read from. @return The newline-terminated String.
   */
   ...
   *
   * @param buffer The ByteBuf to write the String to. @param string The String to write. @param
   * terminator The terminator, indicating the end of the String.
   */
   ...
   * until the specified {@code terminator} is reached. <p> We use a {@link ByteArrayOutputStream}
   * as it is self expanding. We don't want to waste precious time determining a fixed length for
   * the {@code String}. </p>
   *
   * @param buffer The ByteBuf to read from. @param terminator The terminator which denotes when to
   * stop reading. @return The read String.
   */
