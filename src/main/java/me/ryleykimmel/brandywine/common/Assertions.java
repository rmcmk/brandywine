...
public final class Assertions {
   ...
   * 
   * @param value The integer value. @param message The message of the exception thrown if the check
   * fails. @throws IllegalArgumentException If the value cannot be stored in a byte.
   */
   ...
   * 
   * @param value The long value. @param message The message of the exception thrown if the check
   * fails. @throws IllegalArgumentException If the value cannot be stored in an int.
   */
   ...
   * 
   * @param value The value. @param message The message of the exception thrown if the check
   * fails. @throws IllegalArgumentException If the specified value is not negative.
   */
   ...
   * 
   * @param string The string to check. @param message The message of the exception thrown if the
   * check fails. @throws IllegalArgumentException If the string is {@code null} or {@link
   ...
   * 
   * @param value The value. @param message The message of the exception thrown if the check
   * fails. @throws IllegalArgumentException If the specified value is negative.
   */
   ...
   * 
   * @param message The message of the exception thrown if the check fails. @param objects The
   * objects to check. @throws NullPointerException If any of the specified objects are null.
   */
  public static void checkNonNull(String message, Object... objects) {
    if (objects == null || !Stream.of(objects).allMatch(Objects::nonNull)) {
   ...
   * 
   * @param value The value. @param message The message of the exception thrown if the check
   * fails. @throws IllegalArgumentException If the specified value is positive.
   */
   ...
   * 
   * @param value The value. @param message The message of the exception thrown if the check
   * fails. @throws IllegalArgumentException If the specified value is not positive.
   */
   ...
   * 
   * @param value The long value. @param message The message of the exception thrown if the check
   * fails. @throws IllegalArgumentException If the value cannot be stored in a short.
   */
   ...
   * 
   * @param start The start value. @param end The end value. @param value The value to check. @param
   * message The message of the exception thrown if the check fails. @throws
   * IllegalArgumentException If {@code end} is less than {@code start}, or if the check fails.
   */
