...
public final class PlayerUpdateMessage implements Message {
	 ...
	 */
	public PlayerUpdateMessage(Position lastKnownRegion, Position position, int localPlayerCount, PlayerDescriptor descriptor, List<PlayerDescriptor> descriptors) {
