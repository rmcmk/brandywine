...
public final class GameSession {
	...
	public int decipherFrameOpcode(int opcode) {
		Preconditions.checkNotNull(randomPair, "The ciphers were not seeded, ensure GameSession.seedCiphers(int[]) was called.");
	 ...
	 * <p>
	 * If this GameSession is ciphering Frames they have passed the stage of login and the IsaacRandom ciphers were seeded.
	 * </p>
	 *
	 * @return {@code true} if and only if this GameSession is currently ciphering Frames otherwise {@code false}.
	 */
