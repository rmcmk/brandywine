...
public final class FrameReader extends ReadingFrameBuffer {
	...
	/**
	 * Reads a single signed number of the specified DataType in the specified DataOrder and performs the specified DataTransformation on the number if and only if this buffer is
	...
	/**
	 * Reads a single unsigned number of the specified DataType in the {@link DataOrder#BIG big} DataOrder and performs the specified DataTransformation on the number if and only
	...
	/**
	 * Reads a single number of the specified DataType in the specified DataOrder and performs the specified DataTransformation on the number if and only if this buffer is in
	...
	/**
	 * Reads into the specified byte array if and only if this buffer is in {@link AccessMode#BYTE_ACCESS byte access}.
	 *
	...
	/**
	 * Reads into the specified byte array and applies the specified data transformation if and only if this buffer is in {@link AccessMode#BYTE_ACCESS byte access}.
	 *
	...
	/**
	 * Reads into the specified byte array, in reverse, if and only if this buffer is in {@link AccessMode#BYTE_ACCESS byte access}.
	 *
	 * @param bytes The byte array to read into.
	 */
	...
	/**
	 * Reads into the specified byte array, in reverse, and applies the specified data transformation if and only if this buffer is in {@link AccessMode#BYTE_ACCESS byte access}.
	 *
	 * @param transformation The DataTransformation to perform on the bytes.
	 * @param bytes The byte array to read into.
	 */
