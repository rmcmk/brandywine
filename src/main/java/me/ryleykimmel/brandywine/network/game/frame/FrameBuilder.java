...
public final class FrameBuilder extends WritingFrameBuffer implements Builder<Frame> {
	...
	/**
	 * Writes a single number of the specified DataType in the specified DataOrder and performs the specified DataTransformation if and only if this buffer is in
	...
	public void putBits(int amount, int value) {
		Preconditions.checkArgument(amount > 0 && amount <= 32, "Number of bits must be between 1 and 31 inclusive");
		checkBitAccess();
