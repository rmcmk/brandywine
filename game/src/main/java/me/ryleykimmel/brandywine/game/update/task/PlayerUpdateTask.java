...
public final class PlayerUpdateTask implements UpdateTask {
  ...
  /**
   * Creates a PlayerDescriptor based upon the specified Player's current state (walking, running, teleporting, etc).
   *
  ...
  /**
   * Tests whether or not the specified Player has a cached appearance within the specified appearance ticket array.
   *
