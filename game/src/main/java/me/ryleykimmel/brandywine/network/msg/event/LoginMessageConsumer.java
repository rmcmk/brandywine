...
public final class LoginMessageConsumer implements EventConsumer<LoginMessage> {
   ...
   */
  public LoginMessageConsumer(GenericSession session, AuthenticationService service) {
    this.session = Preconditions.checkNotNull(session, "GenericSession may not be null.");
