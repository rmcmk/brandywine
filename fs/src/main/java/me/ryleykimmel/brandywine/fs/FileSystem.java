...
public final class FileSystem {
  ...
  /**
   * A Map of Index ids to Buffers.
   */
  private final Map<Integer, Buffer> files = new HashMap<>();
  ...
  public Archive getArchive(int id) {
    Preconditions.checkElementIndex(id, archives.length,
        "Archive for id: " + id + " does not exist");
  ...
  public Cache getCache(int id) {
    ...
    Preconditions.checkNotNull(caches[id], "Cache for id: " + id + " is null");
